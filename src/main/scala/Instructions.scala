...
/*One use of objects is to contain fields and methods that are independent of any environment.*/

/*Try out parse-upcodes*/
...
object Instructions {
  ...
  def NOP = BitPat.bitPatToUInt(BitPat("b00000000000000000000000000010011"))  //just addi with no operands and rd = 0
}